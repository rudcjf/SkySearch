...
DROP TABLE IF EXISTS SS_CONTACTUS;
...
-- 관리자문의
CREATE TABLE SS_CONTACTUS
(
	CONTACTUS_SEQ varchar(80) NOT NULL,
	-- 이름
	NAME varchar(20),
	-- 핸드폰
	PHONE varchar(40),

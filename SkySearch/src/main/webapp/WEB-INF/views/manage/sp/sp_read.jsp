            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-8 col-md-8">
                     ...
                     <input type="text" value="제주항공 찜 특가">
                     <input type="text" value="베트남 다낭">
                  </div>
                  <div class="col-lg-4 col-md-4 text-right">
                     <h6 class="mt-2">18.07.16 - 18.07.25<!-- 이부분은 특가정보 기간입니다(시작일 - 종료일)  --></h6>
                     <h2 class="text-success">140,000원 ~ <!-- 이부분은 특가정보 가격입니다 --></h2>
                      <input type="text" value="18.07.16 - 18.07.25">
                       <input type="text" value="140,000원 ~ ">
                  </div>
               </div>
               <hr>
                <div class="row">
                  <div class="col-lg-8 col-md-8">
                     <p class="mt-1 mb-0"><i class="mdi mdi-airplane">
                     </i><strong>항공사 : </strong>
                     </p>
                     <input type="text" value="제주항공">
                    	 <!--이 부분은 특가정보의 항공사명입니다 -->
                  </div>
               </div> 
            </div>
                  ...
                  <div class="card padding-card">
                     <div class="card-body">
                        ...
                        <textarea cols="10" rows="10" placeholder="내용을 입력하세요. "
							name="boardContents" class="form-control" >
                        <!-- 이 부분은 특가 게시판 내용입니다(특가 설명) --> 	
						</textarea>
                     </div>
                  </div>
                   <div class="card padding-card">

      ...
      <section class="osahan-slider">
         ...
         <div class="slider-form inner-page-form">
            <div class="container">
               ...
               <form action="<c:url value='/transport/search' />">
                  <div class="row no-gutters">
                     <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="input-group">
                           <div class="input-group-addon"><i class="mdi mdi-map-marker-multiple"></i></div>
                           <select class="form-control select2" name="location1">
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="input-group">
                           ...
                           <select class="form-control select2" name="location2">
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="input-group">
                          ...
                          <!--  <select class="form-control select2" name="location">
                              <option disabled="" selected="">가는날</option>
                     ...
                     <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="input-group">
                           ...
                           <!-- <select class="form-control select2" name="location">
                              <option disabled="" selected="">오는날</option>
                              <option>1</option>
                              <option>2</option>
                              <option>3</option>
                              <option>4</option>
